...
export const sampleCollections: SampleNFTCollection[] = [
  ...
  // Collection 34: Abstract Emotions
  {
    ...
    category: 'digital-art',
    items: [
      { id: '122', title: 'Euphoria', description: 'The feeling of pure joy.', mediaUrl: 'https://images.unsplash.com/photo-1549490349-8643362247b5?w=800&q=80', mediaType: 'image', price: 15.0, category: 'digital-art', tags: ['euphoria', 'joy', 'emotion'], ...getCreator(7), ...getOwner(1), likes: 3456, views: 18234, collectionId: 'collection-34' },
      { id: '123', title: 'Melancholy', description: 'Deep blue sadness visualized.', mediaUrl: 'https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=800&q=80', mediaType: 'image', price: 16.5, category: 'digital-art', tags: ['melancholy', 'blue', 'sadness'], ...getCreator(7), ...getOwner(2), likes: 3234, views: 17456, collectionId: 'collection-34' },
      { id: '124', title: 'Serenity', description: 'Peaceful calm in visual form.', mediaUrl: 'https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?w=800&q=80', mediaType: 'image', price: 15.5, category: 'digital-art', tags: ['serenity', 'calm', 'peace'], ...getCreator(7), ...getOwner(3), likes: 3567, views: 18890, collectionId: 'collection-34' },
      { id: '125', title: 'Passion', description: 'Fiery intensity captured.', mediaUrl: 'https://images.unsplash.com/photo-1604076913837-52ab5629fba9?w=800&q=80', mediaType: 'image', price: 18.0, category: 'digital-art', tags: ['passion', 'fire', 'intense'], ...getCreator(7), ...getOwner(4), likes: 3890, views: 20234, collectionId: 'collection-34' },
      { id: '126', title: 'Nostalgia', description: 'Warm memories of the past.', mediaUrl: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=800&q=80', mediaType: 'image', price: 16.0, category: 'digital-art', tags: ['nostalgia', 'memory', 'warm'], ...getCreator(7), ...getOwner(5), likes: 3345, views: 17890, collectionId: 'collection-34' },
      { id: '127', title: 'Wonder', description: 'Childlike amazement expressed.', mediaUrl: 'https://images.unsplash.com/photo-1482160549825-59d1b23cb208?w=800&q=80', mediaType: 'image', price: 17.0, category: 'digital-art', tags: ['wonder', 'amazement', 'child'], ...getCreator(7), ...getOwner(6), likes: 3678, views: 19345, collectionId: 'collection-34' },
    ],
  },
