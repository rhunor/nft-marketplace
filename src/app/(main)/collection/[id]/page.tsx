  ...
  if (error || !collection) {
    return (
      <div className="flex min-h-[50vh] flex-col items-center justify-center">
        ...
        <p className="mt-2 text-foreground-muted">{error || 'The collection you are looking for does not exist.'}</p>
      ...
      <div className="section-container">
        ...
        <div className="mb-8 grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 grid grid-cols-3 gap-4 rounded-xl border border-border bg-background-card p-4">
              <div>
                <p className="text-xs sm:text-sm text-foreground-muted">Items</p>
                <p className="text-lg sm:text-xl font-bold">{collection.totalItems || nfts.length}</p>
              </div>
              <div>
                <p className="text-xs sm:text-sm text-foreground-muted">Floor Price</p>
                <p className="text-lg sm:text-xl font-bold text-accent-primary">{formatETH(collection.floorPrice)}</p>
              </div>
              <div>
                <p className="text-xs sm:text-sm text-foreground-muted">Total Volume</p>
        ...
        <div className="mt-8">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-lg font-semibold sm:text-xl">Items ({nfts.length})</h2>
          ...
          {nfts.length === 0 && (
            <div className="flex flex-col items-center justify-center rounded-2xl border border-border bg-background-card py-16">
              ...
              <p className="mt-2 text-foreground-muted">This collection has no items.</p>
            </div>
          )}
        </div>
      </div>
